...
namespace Void.ObjectPoolSystem
{
    /*
    ...
    public class ObjectPool<T> : ObjectPool where T : Component
    {
        ...
        private T InstantiateNewObject()
        {
            ...
            var particlesContainer = GameObject.FindAnyObjectByType<ProjectileContainer>().transform;
            obj.transform.SetParent(particlesContainer);
