...
namespace Void.CoreSystem
{
    public class ParticleManager : CoreComponent
    {
        ...
        public void StartAndSetParent(GameObject particlePrefab, Vector2 position, Quaternion rotation, Transform parent)
        {
            var particle = StartParticles(particlePrefab, position, rotation);
