...
namespace Void.Weapons.Components
{
    ...
    public class AttackCharge : AttackData
    {
        ...
        // Sound on charge increase
        [field: SerializeField] public AudioClip ChargeAudio { get; private set; }
        ...
        // Sound on full charge
        [field: SerializeField] public AudioClip FullChargeAudio { get; private set; }
