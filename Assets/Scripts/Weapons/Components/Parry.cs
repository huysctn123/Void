...
using Void.Weapons.Modifiers;
using static Void.Combat.Parry.CombatParryUtilities;
...
namespace Void.Weapons.Components
{
    ...
    public class Parry : WeaponComponent<ParryData, AttackParry>
    {
        ...
        private void HandleParry(GameObject parriedGameObject)
        {
            ...
            particleManager.StartParticlesRelative(currentAttackData.Particles, currentAttackData.ParticlesOffset, Quaternion.identity);
        }
